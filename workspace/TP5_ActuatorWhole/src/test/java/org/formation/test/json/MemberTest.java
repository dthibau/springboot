...
//        assertThat(this.json.write(aMember)).isEqualToJson("expected.json");
        
        assertThat(this.json.write(aMember)).hasJsonPathStringValue("@.email");
        assertThat(this.json.write(aMember)).extractingJsonPathStringValue("@.email")
                .isEqualTo("dd@dd.fr");
    }
